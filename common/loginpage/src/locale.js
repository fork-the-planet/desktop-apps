...
var l10n = l10n || {};
l10n.en = {
    welWelcome: 'Welcome to Euro-Office Desktop Editors!',
    welDescr: 'Work on documents offline or connect the suite to your cloud: Euro-Office, ownCloud, Nextcloud.',
    welNeedHelp: 'Need help? Visit our $1.',
    textHelpCenter: 'Help Center',
    btnConnect: 'Connect now',
    textHavePortal: 'Already use a cloud?',
    btnCreatePortal: 'Create an Euro-Office cloud',
    ...
    portalEmptyAdv1: 'Don\'t have a cloud account yet? Go online with Euro-Office Cloud Service and <br />try collaborative capabilities for free.',
    ...
    linkCreatePortal: 'Create an Euro-Office cloud',
    ...
    loginNoteAssignPhone: 'The two-factor authentication is enabled to provide additional Euro-Office cloud security. Enter your mobile phone number to continue work on the cloud office. Mobile phone number must be entered using an international format with country code.',
    ...
    emptySlide3Text: 'Store your documents in the Euro-Office cloud and access them any time, from anywhere.',
