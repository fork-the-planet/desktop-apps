l10n.cs = {
    welWelcome: 'Vítejte v Euro-Office Desktop Editors!',
    welDescr: 'Práce na dokumentech offline nebo propojení sady do cloudu: Euro-Office, ownCloud, Nextcloud.',
    welNeedHelp: 'Potřebujete pomoct? Navštivte naše $1.',
    textHelpCenter: 'Centrum nápovědy',
    btnConnect: 'Připojit',
    textHavePortal: 'Už používáte cloud?',
    btnCreatePortal: 'Vytvořit Euro-Office cloud',
    ...
    portalEmptyAdv1: 'Nemáte ještě cloud účet? Navštivte službu Cloud Service Euro-Office a vyzkoušejte možnosti spolupráce zdarma.',
    ...
    linkCreatePortal: 'Vytvořit Euro-Office cloud',
    ...
    loginNoteAssignPhone: 'K zajištění další bezpečnosti Euro-Office cloud je zapnuto dvoufaktorové ověřování. Zadejte své číslo mobilního telefonu, abyste mohli pokračovat v práci na kanceláře cloud. Číslo mobilního telefonu musí být zadáno pomocí mezinárodního formátu s kódem země.',
