l10n.it_IT = {
    welWelcome: 'Benvenuti su Euro-Office Desktop Editors!',
    welDescr: 'Lavora ai documenti offline o collega la suite al tuo cloud: Euro-Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crea Euro-Office cloud',
    ...
    portalEmptyAdv1: 'Non hai ancora un account cloud? Vai online con Euro-Office Cloud Service e prova le capacità di collaborazione gratis.',
    ...
    linkCreatePortal: 'Crea Euro-Office cloud',
    ...
    loginNoteAssignPhone: 'L\'autenticazione a due fattori è abilitata per fornire ulteriore sicurezza del Euro-Office cloud. Inserisci il tuo numero di cellulare per continuare a lavorare sul ufficio cloud. Il numero di cellulare deve essere inserito utilizzando un formato internazionale con prefisso internazionale.',
    ...
    emptySlide3Text: 'Archivia i tuoi documenti nel cloud Euro-Office e accedili in qualsiasi momento da qualsiasi luogo.',
