l10n.no = {
    welWelcome: 'Velkommen til Euro-Office redigeringsprogrammer for PC!',
    welDescr: 'Arbeid med dokumenter offline eller koble suiten til din skykonto: Euro-Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Lag en Euro-Office-sky',
    ...
    portalEmptyAdv1: 'Har du ikke konto enda? Koble deg til nettet med Euro-Office skytjeneste og <br />prøv samarbeidsfunksjonene gratis.',
    ...
    linkCreatePortal: 'Sett opp en Euro-Office-sky',
    ...
    loginNoteAssignPhone: 'To-faktor-godkjenning er aktivert for å gi ekstra skysikkerhet for Euro-Office. Skriv inn mobilnummeret ditt for å fortsette å arbeide på skykontoret. Mobiltnummer må angis med et internasjonalt format med landskode.',
    ...
    emptySlide3Text: 'Lagre dokumentene dine i Euro-Office-skyen og få tilgang til dem når som helst, fra hvor som helst.',
