l10n.fr = {
    welWelcome: 'Bienvenue sur Euro-Office Desktop Editors !',
    welDescr: 'Travaillez avec vos documents en mode hors-connexion ou connectez la suite à votre Cloud : Euro-Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Créer un compte Cloud Euro-Office',
    ...
    portalEmptyAdv1: 'Vous n\'avez pas encore de compte Cloud ? Accéder en ligne avec Euro-Office et essayez les capacités de gestion collaborative gratuitement.',
    ...
    linkCreatePortal: 'Créer un compte Cloud Euro-Office',
    ...
    emptySlide3Text: 'Stockez vos documents dans Euro-Office Cloud et accedez-y depuis n\'importe où et à n\'importe quel moment.',
