l10n.ru = {
    welWelcome: 'Добро пожаловать в Euro-Office!',
    welDescr: 'Работайте с документами офлайн или подключитесь к облаку: Euro-Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Создать облако Euro-Office',
    ...
    portalEmptyAdv1: 'Еще нет облачного аккаунта? Перейдите в онлайн-режим с облачным сервисом Euro-Office и попробуйте возможности совместного редактирования бесплатно.',
    ...
    linkCreatePortal: 'Создать облако Euro-Office',
    ...
    loginNoteAssignPhone: 'Для обеспечения повышенной безопасности в облаке Euro-Office включена двухфакторная аутентификация. Для продолжения работы в облачном офисе введите ваш номер мобильного телефона. Номер мобильного телефона необходимо ввести в международном формате с кодом страны.',
    ...
    emptySlide3Text: 'Храните документы в облаке Euro-Office и получайте к ним доступ в любое время, из любой точки мира.',
