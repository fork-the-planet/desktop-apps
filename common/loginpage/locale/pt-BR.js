l10n.pt_BR = {
    welWelcome: 'Bem-vindo ao Euro-Office Desktop Editors!',
    welDescr: 'Trabalhe em documentos offline ou conecte-se à sua nuvem: Euro-Office, ownCloud, Nextcloud.',
    welNeedHelp: 'Precisa de ajuda? Visite nossa $1.',
    textHelpCenter: 'Central de Ajuda',
    btnConnect: 'Conectar',
    textHavePortal: 'Já usa o nuvem?',
    btnCreatePortal: 'Criar Euro-Office na nuvem',
    ...
    portalEmptyAdv1: 'Ainda não tem uma conta? Experimente colaboracão na nuvem do Euro-Office gratuitamente.',
    ...
    linkCreatePortal: 'Criar Euro-Office na nuvem',
    ...
    loginNoteAssignPhone: 'A autenticação de dois fatores está habilitada para fornecer segurança adicional ao nuvem do Euro-Office. Insira o seu número de celular para continuar trabalhando no escritório na nuvem. O número de telefone deve ser inserido usando um formato internacional com o código do país.',
    ...
    emptySlide3Text: 'Armazene seus documentos na nuvem do Euro-Office e acesse-os a qualquer momento, de qualquer lugar.',
