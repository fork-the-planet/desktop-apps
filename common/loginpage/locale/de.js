l10n.de = {
    welWelcome: 'Willkommen in Euro-Office Desktop-Editoren!',
    welDescr: 'Arbeiten Sie offline an Dokumenten oder verbinden Sie die Suite mit Ihrer Cloud: Euro-Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Euro-Office-Cloud erstellen',
    ...
    portalEmptyAdv1: 'Haben Sie noch kein Cloud-Konto? Wechseln Sie zum Onlinemodus mit dem Euro-Office Cloud Service und testen Sie die Möglichkeiten zur Zusammenarbeit  kostenlos.',
    ...
    linkCreatePortal: 'Euro-Office-Cloud erstellen',
    ...
    loginNoteAssignPhone: 'Die Zwei-Faktor-Authentifizierung ermöglicht zusätzliche Euro-Office Cloud Sicherheit. Geben Sie Ihre Handynummer ein, um die Arbeit am Cloud-Büro fortzusetzen. Die Handynummer muss in einem internationalen Format mit Ländervorwahl eingegeben werden.',
    ...
    emptySlide3Text: 'Speichern Sie Ihre Dokumente in der Euro-Office-Cloud und greifen Sie darauf jederzeit von überall zu.',
