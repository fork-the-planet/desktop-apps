l10n.sr_Cyrl_RS = {
    welWelcome: 'Добро дошли у Euro-Office Десктоп Уређиваче!',
    welDescr: 'Радите на документима офлајн или конектујте пакет на свој облак: Euro-Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Креирај Euro-Office облак',
    ...
    portalEmptyAdv1: 'Још увек немате облак рачун? Идите онлајн са Euro-Office Облак сервисом и <br /> покушајте сарађивачке способности бесплатно.',
    ...
    linkCreatePortal: 'Креирај Euro-Office облак',
    ...
    loginNoteAssignPhone: 'Двофакторска аутентикација је омогућена да обезбеди додатну Euro-Office облак безбедност. Унесите свој број телефона да наставите рад на облак офис-у. Број мобилног телефона мора бити унет користећи интернационални формат са кодом државе.',
    ...
    emptySlide3Text: 'Складишти своје документе у Euro-Office облаку и приступи им било када, са било ког места.',
