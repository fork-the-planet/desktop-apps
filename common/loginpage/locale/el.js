l10n.el = {
    welWelcome: 'Καλώς ήλθατε στο Euro-Office Desktop Editors!',
    welDescr: 'Εργαστείτε εκτός σύνδεσης με έγγραφα ή συνδέστε τη σουίτα στο cloud σας: Euro-Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Δημιουργήστε ένα Euro-Office cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία Euro-Office Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός Euro-Office cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο Euro-Office cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
